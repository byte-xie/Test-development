...
def load_test_data():
    ...
    data_path = os.path.join(base_dir, 'data', 'user_delete.yaml')
...
def test_user_delete(case):
    ...
    log_msg = f"user_delete: case_type={case['case_type']}, user_id={user_id}, status={response.status_code}, body={response.text}"
    print(log_msg)
